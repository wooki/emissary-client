...
export default {
  ...
  data() {
    return {
      Colors1: ["#000000","#520000","#ffffff","#990000","#4d123f","#00247d","#002910","#00a3dd","#f8d80e","#ff671f"],
      Colors2: ["#000000","#520000","#ffffff","#992244","#730920","#5037BE","#006627","#00a3dd","#FABD16","#FCA017"],
      Colors3: ["#000000","#AA1313","#C2C2e2","#BA1040","#4d123f","#9181DA","#006627","#00a3dd","#f8d80e","#ffffff"]
    }
  },
